...
public class ServiceFileGenerator implements ICodeGenerator {
	...
	public String fire(Table table) {
		...
		VelocityUtil.export(table.getExportPath() + "service\\", "I" + table.getClassName() + "Service.java", params,
				getVelocityFileName());
	...
	public String getVelocityFileName() {
		return tempalte + "ServiceClassTemplate.vm";
	}
